...
1. Displaying images using Parse/UI (I just used AFNetworking again).
2. Laying out the image in the cell in the feed, they start out edge to edge and then when the cell is reused, they are given a margin out of no where.
